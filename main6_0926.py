    ...
    def goMain  (self):
        ...
        try:
            ...
            if self.mail_login_append==self.password_append:
                ...
                self.ui.label1_2.setText("Please try again")
...
class MainWindow_controller(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.ui.label_2.setText("Mode selection")
    ...
    #输出按钮1与按钮2的状态，选中还是没选中
        if btn.text()=='Realtime':
            if btn.isChecked()==True:
                self.mode="realtime"
                print("已選擇"+btn.text()+"模式")
                self.ui.label_2.setText("Connecting to the camera")
                self.ui.label_2.setAlignment(QtCore.Qt.AlignCenter)
        ...
        if btn.text()=="Video":
            if btn.isChecked() == True:
                self.mode="video"
                print("已選擇"+btn.text()+"模式")
                self.ui.label_2.setText("Select video")
                self.ui.label_2.setAlignment(QtCore.Qt.AlignCenter)
                self.ui.label_2.setFont(QFont('Arial',20))
                self.ui.pushButton_scan.setEnabled(True)
                print(global_login_mail)

        if btn.text()=='Open fence':
            if btn.isChecked()==True:
                self.ui.label_2.setText("Activate fence")
                self.ui.label_2.setAlignment(QtCore.Qt.AlignCenter)
                self.ui.label_2.setFont(QFont('Arial',20))
                self.fencegate=True
    ...
    def doroi(self):
                    ...
                    if a % frame_freq == 0:
                        ...
                        if tracking == False :#and keyName & 0xFF == ord('r'):  
                            ...
                            for i in tracker_list:
                                ...
                                print("You can Select ROI ONE by ONE : " + str(j) + " / 4")
        ...
        if self.mode=="video":
            ...
            if os.path.exists(path1)==True:
                print("mail1_gogogogo")
                self.mail1()
            if os.path.exists(path2)==True:
                print("mail2_gogogogo")
                self.mail2()
            if os.path.exists(path3)==True:
                print("mail3_gogogogo")
                self.mail3()
    ...
    def mail3(self):
        ...
        if self.mail_gate3:
            ...
            content["from"] ="613aeugeneeric00203@gmail.com"  #Sender
            ...
            with smtplib.SMTP(host="smtp.gmail.com", port="587") as smtp:  # Set SMTP Server
                try:
                    ...
                    smtp.login(
                        "613aeugeneeric00203@gmail.com", "bxywdbhhqlnyktfh")  # 登入寄件者gmail
    ...
    def mail2(self):
        ...
        if self.mail_gate2:
            ...
            content["from"] ="613aeugeneeric00203@gmail.com"  #寄件者
...
#不正常的sound
    def ssound3(self):
        #有船入侵
        playsound(r'D://ntut//Any//boxnet//1014GUI//sound//ship1.mp3')
    ...
    def ssound2(self):
        #人很靠近
        playsound(r'D://ntut//Any//boxnet//1014GUI//sound//ship2.mp3')
        print("_________________________________________________________")
        time.sleep(0.1)
        self.flag[0]=1
        self.flagg[0]=1
    ...
    def ssound1(self):
        #警鈴聲
        playsound(r'D:/ntut/Any/boxnet/1014GUI/sound/alarm.mp3')
        print("_________________________________________________________")
        time.sleep(0.1)
        self.flag[0]=1
        self.flagg[0]=1
